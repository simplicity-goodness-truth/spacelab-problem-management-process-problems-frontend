					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Problems processing",
									"targetURL": "#zslpmprprb-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zslpmprprb-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zslpmprprb",
									"url": sap.ui.require.toUrl("zslpmprprb")
								}
							}
						}
					}
